          ...
          <v-row>
            <v-col md="6" sm="12" cols="12">
              <v-select outlined dense hide-details label="เลือก" :items="['เลื่อนนัด', 'ยกเลิก']"
                v-model="FormEdit.Status_nut"></v-select>
            </v-col>
          </v-row>
          <v-row>
            <v-col md="6" sm="12" cols="12">
              <v-menu v-model="menuEdit" :close-on-content-click="false" :nudge-right="40" transition="scale-transition"
                ...
                <v-date-picker v-model="FormEdit.Date_nut" color="deep-orange" @input="menuEdit = false"></v-date-picker>
              </v-menu>
            </v-col>
          </v-row>
          <v-row class="pb-3">
            <v-col md="6" sm="12" cols="12">
              <v-text-field label="เริ่มเวลา" outlined dense hide-details type="time"
                v-model="FormEdit.start_time"></v-text-field>
            </v-col>
            <v-col md="6" sm="12" cols="12">
              <v-text-field label="สิ้นสุด" outlined dense hide-details type="time"
                v-model="FormEdit.end_time"></v-text-field>
            </v-col>
            <v-col md="12" sm="12" cols="12">
              <v-textarea outlined dense hide-details label="หมายเหตุ" rows="3" v-model="FormEdit.Remark"></v-textarea>
            </v-col>
          </v-row>
        </v-card-text>
        <v-card-actions>
